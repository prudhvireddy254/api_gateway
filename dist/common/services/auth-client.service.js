...
const microservice_constants_1 = require("../constants/microservice.constants");
function isMicroserviceError(res) {
...
let AuthClientService = class AuthClientService {
    ...
    async send(cmd, payload) {
        const response = await (0, rxjs_1.firstValueFrom)(this.client.send({ cmd }, payload));
...
exports.AuthClientService = AuthClientService = __decorate([
    ...
    __param(0, (0, common_1.Inject)(microservice_constants_1.AUTH_SERVICE_CLIENT)),
